            ...
            <div className="container-fluid my-5 py-5">
              ...
              <div className="row px-3 px-lg-5">
                <div className="col-12 col-lg-6 px-lg-5">
                  ...
                  {/* .bind method is used to pass the objects to the onsubmit handler which has 
                  the first parameter has default i.e. this */}
                ...
                <div className="col-12 col-lg-6 markdown">
                  ...
                  {/* reactmarkdown is a library imported so as to render the list elements on the body */}
                </div>
              </div>
            </div>
          );
